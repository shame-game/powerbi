/*1697602919,,JIT Construction: v1009303679,en_US*/
...
try {
            ...
            with(this) {
                ...
                __d("JSSDKConfig", [], {
                    "features": {
                        ...
                        "iab_login_status": true,
                        "iab_login_android_support_version": "277.0",
                ...
                __d("JSSDKXDConfig", [], {
                    "XXdUrl": "\/x\/connect\/xd_arbiter\/?version=C-9220483-1009303679-20231017122809",
                    "useCdn": true
                });
                __d("UrlMapConfig", [], {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1009303679","namespace":"FB","message":"' + e.message + '"}}');
