...
! function(t) {
    ...
    r.resize = T(c, I), r.scroll = T(c, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), r.redraw = T(), r.location = function(t) {
        ...
        t = t || {}, v = !0, c.triggerHandler("__wf_destroy"), null != t.domready && (p = t.domready), l.each(i, g), r.resize.off(), r.scroll.off(), r.redraw.off(), o = [], a = [], "pending" === w.state() && x()
    }, u(r.ready), x(), t.exports = window.Webflow = r
}, function(t, e) {
    var n = Array.isArray;
    t.exports = n
}, function(t, e, n) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = g, e.replaceAt = m, e.getIn = E, e.set = y, e.setIn = _, e.update = b, e.updateIn = w, e.merge = I, e.mergeDeep = T, e.mergeIn = O, e.omit = x, e.addDefaults = A;
    /*!
     * Timm
     *
        ...
        var P = e.frame = function() {
            ...
            F = f(function(t) {
                ...
                t.init = function(t, e, n, r) {
                    ...
                    }(e[2], this.ease, a), this.delay = c(e[3], this.delay, u), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = O.test(this.name), this.unit = r.unit || this.unit || H.defaultUnit, this.angle = r.angle || this.angle || H.defaultAngle, H.fallback || r.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + x + this.duration + "ms" + ("ease" != this.ease ? x + l[this.ease][0] : "") + (this.delay ? x + this.delay + "ms" : ""))
                }, t.set = function(t) {
    ...
    function Et(t) {
        ...
        if (A && d) switch (null === (e = I.events[v]) || void 0 === e ? void 0 : e.eventTypeId) {
    ...
    n(131), n(132), n(133), n(135), n(136), n(137), n(138), n(40), n(139), n(25), n(140), n(335), n(336), n(337), n(338), n(339), n(344), n(345), t.exports = n(346)
}, function(t, e, n) {
    "use strict";
    var r = n(0)(n(13));
    ! function() {
    ...
    r.define("ix", t.exports = function(t, e) {
        ...
        function w() {
            ! function() {
                var e = t("[data-ix]");
                if (!e.length) return;
                e.each(O), e.each(I), g.length && (r.scroll.on(x), setTimeout(x, 1));
                m.length && r.load(A);
                E.length && setTimeout(S, y)
            }(), i.init(), r.redraw.up()
        }
        ...
        function I(n, o) {
            ...
            if (f) {
                ...
                d && (a.style(u, f.style), e.each(d, function(t) {
                    ...
                    } else t.preload && !l ? m.push(a) : E.push(a)
                }))
            }
        }
        ...
        return a.init = function(t) {
            ...
            o = !0, v.each(O), r.scroll.off(x), i.async(), g = [], m = [], E = []
        }, a.ready = function() {
    ...
    }, e.destroy = f, e.actions = e.store = void 0, n(142);
    var o = n(88),
        a = i(n(189)),
        u = n(124),
        c = r(n(66));
    ...
    e.ixSession = function() {
        ...
        switch (e.type) {
            ...
            case v:
                for (var A = e.payload, S = A.width, R = A.mediaQueries, C = R.length, N = null, L = 0; L < C; L++) {
                    var D = R[L],
                        P = D.key,
                        M = D.min,
                        j = D.max;
                ...
                return function(t, e, n, r, i) {
                    var o = xt.map(function(t) {
                            ...
                            switch (t) {
                                ...
                                case tt:
                                    return "".concat(T, "(").concat(o).concat(l, ") ").concat(O, "(").concat(u).concat(p, ") ").concat(x, "(").concat(s).concat(h, ")");
                                case et:
                                    return "".concat(A, "(").concat(o).concat(l, ", ").concat(u).concat(p, ")");
                                default:
                                    return ""
                            }
                        }).join(" "),
    ...
    function Et(t) {
        ...
        if (D ? (R = L.limitAffectedElements, C = P, N = l(L)) : C = N = l({
            ...
            var M = a && (N || !0 === A) ? [a] : d(P);
            if (N) {
                if (A === G) return d(N).filter(function(t) {
                    return M.some(function(e) {
                        return m(t, e)
                    })
                });
                if (A === k) return d(N).filter(function(t) {
                    return M.some(function(e) {
                        return m(e, t)
                    })
                });
                if (A === X) return d(N).filter(function(t) {
                    return M.some(function(e) {
                        return y(e, t)
                    })
                })
        ...
        w = function(t, e) {
            ...
            if (E && !_)
                for (var M = 0, j = a.length; M < j; M++) {
                    ...
                    for (var F = (O - b) / w, X = E.config.easing, G = h(X, F, f), U = 0, V = a.length; U < V; U++) {
                        var W = a[U],
                            B = y(s, W, E.config),
    ...
    var c, s, f, l = u(n(31)),
        ...
        K = E.IX2VanillaUtils.getNamespacedParameterId,
        Q = function(t) {
            return function(e) {
        ...
        mt = (r = {}, (0, o.default)(r, S, vt()), (0, o.default)(r, R, ht()), (0, o.default)(r, A, vt()), (0, o.default)(r, x, ht()), (0, o.default)(r, D, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, C, vt()), (0, o.default)(r, N, ht()), (0, o.default)(r, V, {
            ...
            handler: function(t) {
                ...
                return T && (O > .95 || O < .05) && (O = Math.round(O)), (u !== h.EventBasedOn.ELEMENT || A || A !== a.elementHovered) && (O = f ? 1 - O : O, e.dispatch((0, m.parameterChanged)(x, O))), {
                    elementHovered: A,
                    clientX: v,
                    clientY: E,
                    pageX: _,
            ...
            handler: function(t) {
                ...
                if (d === h.EventBasedOn.VIEWPORT) {
                    var x = O ? u / s : c / f;
                    return x !== o.scrollPercent && n.dispatch((0, m.parameterChanged)(v, x)), {
                        scrollPercent: x
                    }
                }
                var A = K(i, v),
                ...
                return P !== o.scrollPercent && n.dispatch((0, m.parameterChanged)(A, P)), {
                    scrollPercent: P
                }
            }
    ...
    r.define("dropdown", t.exports = function(t, e) {
        ...
        function A() {
            n = l && r.env("design"), (c = x.find(v)).each(S)
        }
        ...
        function S(e, i) {
            ...
            f || (f = t.data(i, v, {
                ...
                e.mouseUpOutside && x.off(I, e.mouseUpOutside);
                return s(function(n) {
                    if (e.open) {
                        var i = t(n.target);
            ...
            }(f)), f.toggle.on(I, g), f.toggle.on(y, function(t) {
                var e = C(t, a);
                return function(r) {
                    if (!n) {
        ...
        function N(e) {
            if (!e.open) {
                ...
                var i = r.env("editor");
                n || x.on(I, e.mouseUpOutside), e.hovering && !i && e.el.on(w, e.mouseLeave), e.hovering && i && x.on(b, e.mouseMoveOutside), window.clearTimeout(e.delayId)
            }
        }
        ...
        function L(t) {
            ...
            if (t.open && (!t.config.hover || !t.hovering || r)) {
                ...
                var i = t.config;
                if (g.outro(0, t.el[0]), x.off(I, t.mouseUpOutside), x.off(b, t.mouseMoveOutside), t.el.off(w, t.mouseLeave), window.clearTimeout(t.delayId), !i.delay || n) return t.complete();
        ...
        return f.ready = A, f.design = function() {
            d && x.find(v).each(function(e, n) {
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function _(e, n) {
                ...
                ! function(e, n) {
                    ...
                    if (l.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), h.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), m) f.on("click", function(t) {
                        ...
                        h.on("click keydown", function(t) {
                            ...
                            (r = i.target && i.target.files && i.target.files[0]) && (o.toggle(!1), s.toggle(!1), a.toggle(!0), a.focus(), g.text(r.name), A() || w(n), n.fileUploads[e].uploading = !0, function(e, n) {
                    ...
                    function T(t) {
                        var r = t.responseJSON && t.responseJSON.msg,
                            i = _;
                        "string" == typeof r && 0 === r.indexOf("InvalidFileTypeError") ? i = y : "string" == typeof r && 0 === r.indexOf("MaxFileSizeError") && (i = E), p.text(i), f.removeAttr("data-value"), f.val(""), a.toggle(!1), o.toggle(!0), s.toggle(!0), s.focus(), n.fileUploads[e].uploading = !1, A() || b(n)
                    }
                    ...
                    function x(t) {
                        if (t) return T(t);
                        a.toggle(!1), u.css("display", "inline-block"), u.focus(), n.fileUploads[e].uploading = !1, A() || b(n)
                    }
            ...
            i.handler = null, i.redirect = r.attr("data-redirect"), E.test(s) ? i.handler = x : s || (o ? i.handler = O : y())
        }
    ...
    r.define("slider", t.exports = function(t, e) {
        ...
        function D(e, n) {
            ...
            var l = e.offsetX || 0,
                ...
                I = "opacity " + b + "ms " + _,
                T = "transform " + b + "ms " + _;
            if (v.find(a).removeAttr("tabindex"), v.removeAttr("aria-hidden"), v.find("*").removeAttr("aria-hidden"), g.find(a).attr("tabindex", "-1"), g.attr("aria-hidden", "true"), g.find("*").attr("aria-hidden", "true"), u || (v.each(m.intro), g.each(m.outro)), n.immediate && !E) return f(v).set(p), void A();
...
Webflow.require('ix').init([{
        "slug": "cronologics-research-bar",
        "name": "cronologics-research-bar",
        "value": {
            "style": {
                "width": "0%"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "width": "80%",
                    "transition": "transform 800ms ease 0, width 800ms ease 0, opacity 800ms ease 0",
                    "x": "0px",
                    "y": "0px",
                    "z": "0px"
                }],
    ...
    {
        "slug": "cronologics-interaction-bar",
        "name": "cronologics-interaction-bar",
        "value": {
            "style": {
                "width": "0%"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "width": "97%",
                    "transition": "width 900ms ease 0, opacity 200 ease 0"
                }],
                "stepsB": [{
                    "opacity": 1,
                    "width": "0%",
                    "transition": "width 800ms ease 0, opacity 200 ease 0"
                }]
            }]
        }
    },
    {
        "slug": "cronologics-visual-bar",
        "name": "cronologics-visual-bar",
        "value": {
            "style": {
                "width": "0%"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "width": "100%",
                    "transition": "width 1000ms ease 0, opacity 200 ease 0"
                }],
                "stepsB": [{
                    "opacity": 1,
                    "width": "0%",
    ...
    {
        "slug": "cronologics-front-end-bar",
        "name": "cronologics-front-end-bar",
        "value": {
            "style": {
                "width": "0%"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "width": "40%",
                    "transition": "width 1100ms ease 0, opacity 200 ease 0"
                }],
                "stepsB": [{
                    "opacity": 1,
                    "width": "0%",
                    "height": "15px",
                    "transition": "width 200 ease 0, height 200 ease 0, opacity 200 ease 0"
                }]
            }]
        }
    },
    {
        ...
        "value": {
            ...
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "transition": "opacity 900ms ease 0, transform 1100ms ease 0",
                    "x": "0px",
                    "y": "0px",
                    "z": "0px"
                }],
                "stepsB": [{
                    "opacity": 0,
                    "transition": "opacity 900ms ease 0, transform 900ms ease 0",
                    "x": "0px",
                    "y": "50px",
                    "z": "0px"
                }]
    ...
    {
        "slug": "cronologics-project",
        "name": "cronologics-project",
        "value": {
            "style": {
                "opacity": 0
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "transition": "transform 1000ms ease 0, opacity 900ms ease 0",
                    "x": "0px",
                    "y": "-30px",
                    "z": "0px"
                }],
                "stepsB": [{
                    "opacity": 0,
                    "transition": "opacity 900ms ease 0, transform 1000ms ease 0",
                    "x": "0px",
                    "y": "30px",
                    "z": "0px"
                }]
    ...
    {
        "slug": "vacaybug-project",
        "name": "vacaybug-project",
        "value": {
            "style": {
                "opacity": 0
            },
    ...
    {
        "slug": "kifi-research-bar",
        "name": "kifi-research-bar",
        "value": {
            "style": {
                "width": "0%"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "width": "60%",
                    "transition": "opacity 900ms ease 0, width 900ms ease 0, transform 200 ease 0"
                }],
                "stepsB": [{
                    "opacity": 1,
                    "width": "0%",
                    "transition": "width 900ms ease 0, opacity 900ms ease 0"
                }]
            }]
        }
    },
    {
        "slug": "kifi-interaction-bar",
        "name": "kifi-interaction-bar",
        "value": {
            "style": {
                "width": "0%"
            },
            "triggers": [{
                ...
                "stepsB": [{
                    "opacity": 1,
                    "width": "0%",
                    "transition": "width 1000ms ease 0, opacity 900ms ease 0"
                }]
            }]
        }
    },
    {
        "slug": "kifi-visual-bar",
        "name": "kifi-visual-bar",
        "value": {
            "style": {
                "width": "0%"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "width": "100%",
                    "transition": "width 1100ms ease 0, opacity 900ms ease 0"
                }],
                "stepsB": [{
                    "opacity": 1,
                    "width": "0%",
    ...
    {
        "slug": "kifi-marketing-bar",
        "name": "kifi-marketing-bar",
        "value": {
            "style": {
                "width": "0%"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "width": "98%",
                    "transition": "width 1200ms ease 0, opacity 900ms ease 0"
                }],
                "stepsB": [{
                    "opacity": 1,
                    "width": "0%",
    ...
    {
        "slug": "kifi-illustration-bar",
        "name": "kifi-illustration-bar",
        "value": {
            "style": {
                "opacity": 1,
                "width": "0%"
            ...
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "width": "40%",
                    "transition": "width 1300ms ease 0, opacity 900ms ease 0"
                }],
                "stepsB": [{
                    "opacity": 1,
                    "width": "0%",
                    "transition": "opacity 900ms ease 0, width 1300ms ease 0"
                }]
            }]
        }
    },
    {
        "slug": "vacaybug-research-bar",
        "name": "vacaybug-research-bar",
        "value": {
            "style": {
                "width": "0%"
            },
    ...
    {
        "slug": "vacaybug-interaction-bar",
        "name": "vacaybug-interaction-bar",
        "value": {
            "style": {
                "width": "0%"
            },
    ...
    {
        "slug": "vacaybug-visual-bar",
        "name": "vacaybug-visual-bar",
        "value": {
            "style": {
                "width": "0%"
            },
    ...
    {
        "slug": "vacaybug-marketing-bar",
        "name": "vacaybug-marketing-bar",
        "value": {
            "style": {
                "width": "0%",
                "x": "0px",
    ...
    {
        "slug": "vacaybug-product-thinking-bar",
        "name": "vacaybug-product-thinking-bar",
        "value": {
            "style": {
                "width": "0%"
            },
...
Webflow.require('ix2').init({
    "events": {
        ...
        "e-9": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|c5ed9e5d-e92c-fb1a-b164-0c3bc9a68594",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-11": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|fb633824-b6c5-965a-8069-2804aec05a9e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-13": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|f8ee3763-c4a7-f15b-ffab-5c41eedeb7c8",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-15": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|ae6060a1-78b1-1b88-16e1-83c08d891a13",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-17": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|ff9b3e0c-e6de-537d-3503-423a98533519",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-19": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|67d9e6f5-b6f7-169d-3455-d2e3edb54ea3",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-21": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|67d9e6f5-b6f7-169d-3455-d2e3edb54ea4",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-23": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|f8ee3763-c4a7-f15b-ffab-5c41eedeb7d8",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-25": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|f8ee3763-c4a7-f15b-ffab-5c41eedeb7d9",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-27": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5872dded6232879a6ff550a7|c8816b34-0b56-903d-8579-703a271257de",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-28": {
            ...
            "createdOn": 1563662674986
        }
    },
    "actionLists": {
        "a": {
            "id": "a",
            "title": "Progress-scroll-indicator",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["d34113fa-7393-d3f0-e4e3-ee48b127f80c"]
                            },
                            "xValue": 0,
                            "locked": false
                        }
            ...
            "createdOn": 1526151257091
        },
        "a-2": {
            "id": "a-2",
            "title": "Scroll in cronologics",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "id": "5872dded6232879a6ff550a7|b5571e93-1b02-adf8-1d8f-439f8de71716"
                        },
                        "value": 0,
                        "unit": ""
                    }
            ...
            "createdOn": 1563587843373
        },
        "a-3": {
            "id": "a-3",
            "title": "Scroll out cronologics",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-3-n",
                    "actionTypeId": "STYLE_OPACITY",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "SIBLINGS",
                            "selector": ".home-page-bg-color.cronologics",
                            "selectorGuids": ["793d625e-8d44-28d6-c8ed-e703ca5d71a0", "5df3e698-44ae-64d4-80e0-045f11f4399b"]
                        },
                        "value": 0,
                        "unit": ""
                    }
        ...
        "a-4": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "SIBLINGS",
                            "id": "5872dded6232879a6ff550a7|a6e469fa-f842-b3d7-60e4-da2ff47ce7a0"
                        },
                        "value": 0,
                        "unit": ""
                    }
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1563588652440
        },
        "a-5": {
            "id": "a-5",
            "title": "Scroll out kifi",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-5-n",
                    "actionTypeId": "STYLE_OPACITY",
            ...
            "useFirstGroupAsInitialState": false,
            "createdOn": 1563588809032
        },
        "a-6": {
            "id": "a-6",
            "title": "Scroll in vacaybug",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-6-n",
                    "actionTypeId": "STYLE_OPACITY",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "SIBLINGS",
                            "selector": ".home-page-bg-color.vacaybug",
                            "selectorGuids": ["793d625e-8d44-28d6-c8ed-e703ca5d71a0", "7708ed69-5f31-b206-b885-286f6f5095c2"]
                        },
                        "value": 0,
                        "unit": ""
                    }
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1563588949878
        },
        "a-7": {
            "id": "a-7",
            "title": "Scroll out vacaybug",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-7-n",
                    "actionTypeId": "STYLE_OPACITY",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "SIBLINGS",
                            "selector": ".home-page-bg-color.form",
                            "selectorGuids": ["793d625e-8d44-28d6-c8ed-e703ca5d71a0", "ab15b41b-d30a-b5ff-930f-afbe8d80703a"]
                        },
                        "value": 0,
                        "unit": ""
                    }
